...
img_enemy = "ufo.png" #enemy
score = 0 #ships destroyed
goal = 30 #how many ships need to be shot down to win
lost = 0 #ships missed
max_lost = 3 #lose if you miss that many
#parent class for other sprites
class GameSprite(sprite.Sprite):
...
class Player(GameSprite):
 ...
 #method to "shoot" (use the player position to create a bullet there)
   def fire(self):
       bullet = Bullet(img_bullet, self.rect.centerx, self.rect.top, 15, 20, -15)
       bullets.add(bullet)
       bullet = Bullet(img_bullet, self.rect.centerx- randint(1,60), self.rect.top- randint(1,60), 15, 20, -15)
       bullets.add(bullet)
       bullet = Bullet(img_bullet, self.rect.centerx- randint(1,60), self.rect.top- randint(1,40), 15, 20, -15)
       bullets.add(bullet)
       bullet = Bullet(img_bullet, self.rect.centerx- randint(1,60), self.rect.top- randint(1,60), 15, 20, -15)
       bullets.add(bullet)
       bullet = Bullet(img_bullet, self.rect.centerx- randint(1,60), self.rect.top- randint(1,60), 15, 20, -15)
